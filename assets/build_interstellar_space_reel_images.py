...
out_dir = "assets/interstellar_space_reel/images"
...
bg1_raw = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s01_bg_1789195938508.jpg").convert("RGBA")
bg1 = bg1_raw.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)

# Subtle vignette / bottom & top darkening for typography & presenter contrast
...
for y in range(TARGET_HEIGHT - 650, TARGET_HEIGHT):
    ...
    v_draw.line([(0, y), (TARGET_WIDTH, y)], fill=(2, 4, 12, alpha))
...
# Typography: Title "INTERSTELLAR SPACE" and Hook "พ้นระบบสุริยะ... เราเจออะไร?"
font_chonburi_title = ImageFont.truetype("assets/fonts/Chonburi.ttf", 78)
font_chonburi_hook = ImageFont.truetype("assets/fonts/Chonburi.ttf", 52)

title_text = "INTERSTELLAR SPACE"
hook_text = "พ้นระบบสุริยะ... เราเจออะไร?"
...
for y in range(pos_y_title - 10, pos_y_title + 100):
    rel = (y - pos_y_title) / 80.0
...
# -------------------------------------------------------------
# 2. SCENE 02: Voyager 1 Heliopause
# -------------------------------------------------------------
print("Processing Scene 02...")
im2 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s02_heliopause_1789196229685.jpg")
im2_fit = im2.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s02_final = apply_logo(im2_fit)
s02_final.save(os.path.join(out_dir, "scene-02-heliopause.png"), "PNG")
print("Scene 02 saved.")

# -------------------------------------------------------------
# 3. SCENE 03: Galactic Cosmic Rays
# -------------------------------------------------------------
print("Processing Scene 03...")
im3 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s03_cosmic_rays_1789196248207.jpg")
im3_fit = im3.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s03_final = apply_logo(im3_fit)
s03_final.save(os.path.join(out_dir, "scene-03-cosmic-rays.png"), "PNG")
print("Scene 03 saved.")

# -------------------------------------------------------------
# 4. SCENE 04: Interstellar Plasma (ISM)
# -------------------------------------------------------------
print("Processing Scene 04...")
im4 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s04_plasma_ism_1789196416821.jpg")
im4_fit = im4.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s04_final = apply_logo(im4_fit)
s04_final.save(os.path.join(out_dir, "scene-04-plasma-ism.png"), "PNG")
print("Scene 04 saved.")

# -------------------------------------------------------------
# 5. SCENE 05: Cosmic Dust & Chemistry
# -------------------------------------------------------------
print("Processing Scene 05...")
im5 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s05_cosmic_dust_1789196843557.jpg")
im5_fit = im5.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s05_final = apply_logo(im5_fit)
s05_final.save(os.path.join(out_dir, "scene-05-cosmic-dust.png"), "PNG")
print("Scene 05 saved.")

# -------------------------------------------------------------
# 6. SCENE 06: Local Interstellar Cloud
# -------------------------------------------------------------
print("Processing Scene 06...")
im6 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s06_local_cloud_1789196886426.jpg")
im6_fit = im6.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s06_final = apply_logo(im6_fit)
s06_final.save(os.path.join(out_dir, "scene-06-local-cloud.png"), "PNG")
print("Scene 06 saved.")

# -------------------------------------------------------------
# 7. SCENE 07: Galactic Magnetic Fields
# -------------------------------------------------------------
print("Processing Scene 07...")
im7 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s07_magnetic_fields_1789197293463.jpg")
im7_fit = im7.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s07_final = apply_logo(im7_fit)
s07_final.save(os.path.join(out_dir, "scene-07-magnetic-fields.png"), "PNG")
print("Scene 07 saved.")

# -------------------------------------------------------------
# 8. SCENE 08: Cosmic Cradle Payoff
# -------------------------------------------------------------
print("Processing Scene 08...")
im8 = Image.open("/Users/zengcode/.gemini/antigravity/brain/be4e5334-0b2c-43a2-b1e0-78f58d22bc55/interstellar_s08_cosmic_cradle_1789197324905.jpg")
im8_fit = im8.resize((TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
s08_final = apply_logo(im8_fit)
s08_final.save(os.path.join(out_dir, "scene-08-cosmic-cradle.png"), "PNG")
...
# Rule: Exact byte-for-byte or rescaled without modification/logo
